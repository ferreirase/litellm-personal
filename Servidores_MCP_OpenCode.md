...
#### [Avisos](https://opencode.ai/docs/pt-br/mcp-servers/#avisos)
...
## [Habilitando](https://opencode.ai/docs/pt-br/mcp-servers/#habilitando)
...
### [Substituindo padrões remotos](https://opencode.ai/docs/pt-br/mcp-servers/#substituindo-padr%C3%B5es-remotos)
...
Os valores da sua configuração local substituem os padrões remotos. Veja [precedência de configuração](https://opencode.ai/docs/config#precedence-order) para mais detalhes.

---

## [Local](https://opencode.ai/docs/pt-br/mcp-servers/#local)
...
#### [Opções](https://opencode.ai/docs/pt-br/mcp-servers/#op%C3%A7%C3%B5es)
...
Tipo de conexão do servidor MCP, deve ser `"local"`.
...
Comando e argumentos para executar o servidor MCP.

`environment`

Object

Variáveis de ambiente a serem definidas ao executar o servidor.

`enabled`

Boolean

Habilitar ou desabilitar o servidor MCP na inicialização.

`timeout`

Number

Tempo limite em ms para buscar ferramentas do servidor MCP. O padrão é 5000 (5 segundos).

---

## [Remoto](https://opencode.ai/docs/pt-br/mcp-servers/#remoto)
...
#### [Opções](https://opencode.ai/docs/pt-br/mcp-servers/#op%C3%A7%C3%B5es-1)
...
Tipo de conexão do servidor MCP, deve ser `"remote"`.
...
Configuração de autenticação OAuth. Veja a seção [OAuth](https://opencode.ai/docs/pt-br/mcp-servers/#oauth) abaixo.
...
## [OAuth](https://opencode.ai/docs/pt-br/mcp-servers/#oauth)
...
### [Automático](https://opencode.ai/docs/pt-br/mcp-servers/#autom%C3%A1tico)
...
Se o servidor requer autenticação, o opencode solicitará que você se autentique quando tentar usá-lo pela primeira vez. Se não, você pode [iniciar manualmente o fluxo](https://opencode.ai/docs/pt-br/mcp-servers/#authenticating) com `opencode mcp auth <server-name>`.

---

### [Pré-registrado](https://opencode.ai/docs/pt-br/mcp-servers/#pr%C3%A9-registrado)
...
### [Autenticação](https://opencode.ai/docs/pt-br/mcp-servers/#autentica%C3%A7%C3%A3o)
...
#### [Desabilitando OAuth](https://opencode.ai/docs/pt-br/mcp-servers/#desabilitando-oauth)
...
#### [Opções de OAuth](https://opencode.ai/docs/pt-br/mcp-servers/#op%C3%A7%C3%B5es-de-oauth)
...
Objeto de configuração OAuth, ou `false` para desabilitar a detecção automática de OAuth.

`clientId`

String

ID do cliente OAuth. Se não fornecido, o registro dinâmico do cliente será tentado.

`clientSecret`

String

Segredo do cliente OAuth, se necessário pelo servidor de autorização.

`scope`

String

Escopos OAuth a serem solicitados durante a autorização.

#### [Depuração](https://opencode.ai/docs/pt-br/mcp-servers/#depura%C3%A7%C3%A3o)
...
## [Gerenciamento](https://opencode.ai/docs/pt-br/mcp-servers/#gerenciamento)
...
### [Global](https://opencode.ai/docs/pt-br/mcp-servers/#global)
...
### [Por agente](https://opencode.ai/docs/pt-br/mcp-servers/#por-agente)
...
2.  Em sua [configuração de agente](https://opencode.ai/docs/agents#tools), habilite o servidor MCP como uma ferramenta.
...
#### [Padrões glob](https://opencode.ai/docs/pt-br/mcp-servers/#padr%C3%B5es-glob)
...
### [Context7](https://opencode.ai/docs/pt-br/mcp-servers/#context7)
...
Alternativamente, você pode adicionar algo assim ao seu [AGENTS.md](https://opencode.ai/docs/rules/).
...
### [Grep by Vercel](https://opencode.ai/docs/pt-br/mcp-servers/#grep-by-vercel)
...
---
Source: [Servidores MCP](https://opencode.ai/docs/pt-br/mcp-servers/)